...
import ast.*;
import frontend.entity.ClassEntity;
import frontend.entity.FuncEntity;
import frontend.entity.VarEntity;
import frontend.type.ClassType;
import frontend.type.Type;
import frontend.type.VoidType;
import ir.BasicBlock;
import ir.GlobalVarInit;
...
public class IRBuilder implements ASTVisitor {
    ...
    public void visit(FuncDefNode node) {
        ...
        BlockStmtNode blockStmtNode = node.getStmt();
        curScope = new Scope(oldScope);
